  ...
  return <Wrapper>
    ...
    <form>
      ...
      <select name="sort" id="sort" className="sort-input" value={sort} onChange={updateSort}>
        <option className="price-lowest">price (lowest)</option>
        <option className="price-highest">price (highest)</option>
        <option className="name-a">name (a-z)</option>
        <option className="name-z">name (z-a)</option>
      </select>
    </form>
  </Wrapper>
}
